    ...
    MainGameJS: [function (e, t) {
        ...
        e("../MainManage").endHttpShowInfo, cc.Class({
            ...
            onLoad: function () {//游戏初始化
                ...
                this.playerNode.typeID = 8, /*初始化大小，最大是8，形态不变等级为最高*/this.createMap(), this.maxCameraMovePosX = Math.abs(this.BGArr[0][this.BGNum - 1].x) - this.gameWidth, this.maxCameraMovePosY = Math.abs(this.BGArr[0][this.BGNum - 1].y) - this.gameHeight / 2;
